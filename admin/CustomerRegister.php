    ...
    <div class="modal fade" id="DeleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="adminCode.php" method="post">
                    <div class="modal-body">
                        <input type="text" name="delete_id" value="" class="delete_customer_id">
                        <p>Are you sure You want to delete the data?</p>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" name="deleteCustomerbtn" class="btn btn-primary">YEs,Delete</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $query = "select  * from uuser  where user_type='user' ";
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        foreach ($query_run as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="CustomerEdit.php?user_id=<?php echo $row['user_id']; ?>"
