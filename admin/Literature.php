...
<section class="products">
    <h1 class="heading">Literature</h1>
    <div class="box-container">
        <?php
        $select_books = mysqli_query($con, "SELECT books.* FROM books INNER JOIN category ON books.category_id = category.category_id WHERE category.category_name = 'literature'");
            ...
            while ($fetch_books = mysqli_fetch_assoc($select_books)) {
                ...
                <form action="" method="post" class="add-to-cart-form">
                    <div class="box">
                        ...
                        <input type="submit" class="btn add-to-cart-btn" value="Add to Cart" name="add_to_cart">
