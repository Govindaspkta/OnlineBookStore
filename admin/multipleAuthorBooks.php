...
<div class="content-wrapper">
            ...
            <div class="modal-content">
                ...
                <form action="adminCode.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="BookName">
                        </div>
                        <div class="form-group">
                        <select name="author" class="form-control">
                            ...
                            <option value="<?= $authors['author_id'] ?>">
                                <?= $authors['name'] ?> <!-- Corrected echo statement -->
                            </option>
                            <?php }
                            } ?>
                        </select>
    ...
    <option value="<?= $categories['category_id'] ?>">
        <?= $categories['category_name'] ?> <!-- Corrected echo statement -->
    </option>
    <?php }
    } ?>
</select>
