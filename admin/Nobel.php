...
<section class="products">
    ...
    <div class="box-container">
        <?php
        $select_books = mysqli_query($con, "SELECT books.* FROM books INNER JOIN category ON books.category_id = category.category_id WHERE category.category_name = 'nobel'");
