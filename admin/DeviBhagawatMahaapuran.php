...
<head>
    ...
    <title>Devi Bhagawat Mahapuran</title>
    <style>
...
<body>
    ...
    <main>
        <div class="container">
            ...
            $select_books = mysqli_query($con,"SELECT books.*, author.name AS author_name FROM books INNER JOIN author ON books.author_id = author.author_id INNER JOIN category ON books.category_id = category.category_id WHERE category.category_name = 'Literature' AND books.title = 'Devi Bhagawat Mahaapuran'");
